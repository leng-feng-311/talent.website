...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'Calendar',
        ...
        template =  ''+
            ...
            '<tfoot>' +
            '<th colspan="2" class="sel" id="last"><div class="arrow"><i class="glyphicon glyphicon-circle-arrow-left"></i></div></th>' +
            '<th colspan="3" class="sel" id="current"><span class="year"></span><span class="month"></span></th>' +
            '<th colspan="2" class="sel" id="next"><div class="arrow"><i class="glyphicon glyphicon-circle-arrow-right"></i></div></th>' +
            '</tfoot>' +
